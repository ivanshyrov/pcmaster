...
const LINE_BASE = { r: 15, g: 23, b: 42, a: 0.08 }; // тёмный, под светлый фон
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const theme = {
        default: {
          bg: "#f4f6fb", // светлый фон под сайт
          lineActive: { r: 37, g: 99, b: 235, a: 0.7 },
  ...
  return (
    <div
      className={cn(
        ...
        globalColor === "monochrome" ? "bg-[#000000]" : "bg-[#f4f6fb]",
        className,
      )}
    >
      <canvas
